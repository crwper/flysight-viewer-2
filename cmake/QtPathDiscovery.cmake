...
function(find_qt6_resource_dirs)
    ...
    if(_plugins_dir AND EXISTS "${_plugins_dir}/geoservices")
        file(GLOB _geo_plugins "${_plugins_dir}/geoservices/*")
        list(LENGTH _geo_plugins _geo_count)
        message(STATUS "  Geoservices plugins available: ${_geo_count}")
    else()
        message(STATUS "  Geoservices plugins: NOT FOUND")
    endif()

    # Check for QtLocation QML module (commonly needed)
    if(_qml_dir AND EXISTS "${_qml_dir}/QtLocation")
        message(STATUS "  QtLocation QML module: Found")
    else()
        message(STATUS "  QtLocation QML module: NOT FOUND")
    endif()

    # Check for QtPositioning QML module (commonly needed)
    if(_qml_dir AND EXISTS "${_qml_dir}/QtPositioning")
        message(STATUS "  QtPositioning QML module: Found")
    else()
        message(STATUS "  QtPositioning QML module: NOT FOUND")
    endif()
